...
class LoadFixturesData extends AbstractFixture implements FixtureInterface
{
    ...
    public function createGames(ObjectManager $manager)
    {
        ...
        $games = array(
            ...
            array(0,0,'27-09-2014 16:00:00',$lasalle,$castellgali,'SCHEDULED',$roundA14152),
            array(0,0,'27-09-2014 18:00:00',$sallent,$joanenc,'SCHEDULED',$roundA14152),
            array(0,0,'28-09-2014 11:00:00',$marroc,$castellbell,'SCHEDULED',$roundA14152),
            array(0,0,'28-09-2014 10:00:00',$berga,$minorisa,'SCHEDULED',$roundA14152),
            array(0,0,'27-09-2014 19:00:00',$castellet,$lacoromina,'SCHEDULED',$roundA14152),
            array(0,0,'28-09-2014 10:00:00',$balsareny,$santpedor,'SCHEDULED',$roundA14152),
            array(0,0,'27-09-2014 18:00:00',$pirinaica,$america,'SCHEDULED',$roundB14152),
            array(0,0,'27-09-2014 18:30:00',$atgironella,$navarcles,'SCHEDULED',$roundB14152),
            array(0,0,'27-09-2014 16:30:00',$castellnou,$monistrol,'SCHEDULED',$roundB14152),
            array(0,0,'27-09-2014 20:00:00',$solsona,$avinyo,'SCHEDULED',$roundB14152),
            array(0,0,'27-09-2014 17:30:00',$udbalsareny,$navas,'SCHEDULED',$roundB14152),
            array(0,0,'27-09-2014 16:00:00',$atcastellbell,$guardiolenca,'SCHEDULED',$roundB14152),
            array(0,0,'28-09-2014 11:00:00',$callus,$olesa,'SCHEDULED',$roundC14152),
            array(0,0,'27-09-2014 18:00:00',$fruitosenc,$puigreig,'SCHEDULED',$roundC14152),
            array(0,0,'28-09-2014 10:30:00',$artes,$vilomara,'SCHEDULED',$roundC14152),
            array(0,0,'27-09-2014 17:00:00',$calrosal,$suria,'SCHEDULED',$roundC14152),
            array(0,0,'27-09-2014 17:00:00',$xup,$verdiblanca,'SCHEDULED',$roundC14152),
            array(0,0,'27-09-2014 19:00:00',$pradenc,$pala,'SCHEDULED',$roundC14152),

            array(0,0,'04-10-2014 00:00:00',$castellgali,$santpedor,'CALENDAR',$roundA14153),
            array(0,0,'04-10-2014 00:00:00',$lacoromina,$balsareny,'CALENDAR',$roundA14153),
            array(0,0,'04-10-2014 00:00:00',$minorisa,$castellet,'CALENDAR',$roundA14153),
            array(0,0,'04-10-2014 00:00:00',$castellbell,$berga,'CALENDAR',$roundA14153),
            array(0,0,'04-10-2014 00:00:00',$joanenc,$marroc,'CALENDAR',$roundA14153),
            array(0,0,'04-10-2014 00:00:00',$lasalle,$sallent,'CALENDAR',$roundA14153),
            array(0,0,'04-10-2014 00:00:00',$america,$guardiolenca,'CALENDAR',$roundB14153),
            array(0,0,'04-10-2014 00:00:00',$navas,$atcastellbell,'CALENDAR',$roundB14153),
            array(0,0,'04-10-2014 00:00:00',$avinyo,$udbalsareny,'CALENDAR',$roundB14153),
            array(0,0,'04-10-2014 00:00:00',$monistrol,$solsona,'CALENDAR',$roundB14153),
            array(0,0,'04-10-2014 00:00:00',$navarcles,$castellnou,'CALENDAR',$roundB14153),
            array(0,0,'04-10-2014 00:00:00',$pirinaica,$atgironella,'CALENDAR',$roundB14153),
            array(0,0,'04-10-2014 00:00:00',$olesa,$pala,'CALENDAR',$roundC14153),
            array(0,0,'04-10-2014 00:00:00',$verdiblanca,$pradenc,'CALENDAR',$roundC14153),
            array(0,0,'04-10-2014 00:00:00',$suria,$xup,'CALENDAR',$roundC14153),
            array(0,0,'04-10-2014 00:00:00',$vilomara,$calrosal,'CALENDAR',$roundC14153),
            array(0,0,'04-10-2014 00:00:00',$puigreig,$artes,'CALENDAR',$roundC14153),
            array(0,0,'04-10-2014 00:00:00',$callus,$fruitosenc,'CALENDAR',$roundC14153),
