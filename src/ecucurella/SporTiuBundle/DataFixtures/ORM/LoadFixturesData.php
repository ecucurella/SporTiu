...
class LoadFixturesData extends AbstractFixture implements FixtureInterface
{
    ...
    public function createGames(ObjectManager $manager)
    {
        ...
        $games = array(
            ...
            array(2,0,'22-09-2013 11:00:00',$artes,$castellnou,'SUSPENDED',$round2),
    ...
    public function createRounds(ObjectManager $manager)
    {
        ...
        $rounds = array(
            ...
            array('Jornada1','1',$leagueB, false),
            array('Jornada2','2',$leagueB, false),
            array('Jornada3','3',$leagueB, false),
            array('Jornada4','4',$leagueB, false),
            array('Jornada5','5',$leagueB, false),
            array('Jornada6','6',$leagueB, false),
            array('Jornada7','7',$leagueB, false),
            array('Jornada8','8',$leagueB, false),
            array('Jornada9','9',$leagueB, false),
            array('Jornada10','10',$leagueB, false),
            array('Jornada11','11',$leagueB, false),
            array('Jornada12','12',$leagueB, false),
            array('Jornada13','13',$leagueB, false),
            array('Jornada14','14',$leagueB, false),
            array('Jornada15','15',$leagueB, false),
            array('Jornada16','16',$leagueB, false),
            array('Jornada17','17',$leagueB, false),
            array('Jornada18','18',$leagueB, false),
            array('Jornada19','19',$leagueB, false),
            array('Jornada20','20',$leagueB, false),
            array('Jornada21','21',$leagueB, false),
